...
const VellumApp = () => {
              ...
              <Box padding="600">
                <BlockStack gap="400" inlineAlign="center">
                  ...
                  <InlineStack gap="300" align="center">
                    <Button variant="primary" size="large" onClick={() => setCurrentScreen('products')}>
                      Shop All Products
                    </Button>
                    <Button variant="secondary" size="large" onClick={() => setCurrentScreen('business-app')}>
  ...
  const ProductDetailScreen = () => {
    ...
    const safetyProduct = safetyProducts.products.find(p => p.id.toString() === selectedProductId?.toString());
    const displayProduct = safetyProduct || safetyShirtProduct || constructionProduct || selectedProduct;
    ...
    const productImages = safetyProduct?.images || safetyShirtProduct?.images || constructionProduct?.images || [{
      id: 1,
    ...
    return (
      <Page 
        ...
        secondaryActions={[
          {content: 'Add to Cart'},
          {content: `Buy Now - $${safetyProduct?.price_numeric || safetyShirtProduct?.price_numeric || constructionProduct?.price_numeric || displayProduct.price}`}
        ]}
      >
        <Layout>
          <Layout.Section>
                ...
                <Card>
                  <Box padding="400">
                    <BlockStack gap="400">
                      ...
                      {/* Product Tags */}
                      {(safetyProduct?.tags || safetyShirtProduct?.tags || constructionProduct?.tags) && (safetyProduct?.tags || safetyShirtProduct?.tags || constructionProduct?.tags).length > 0 && (
                        <div>
                          <Text variant="headingSm" as="h4" tone="subdued">Tags</Text>
                          <Box paddingBlockStart="200">
                            <InlineStack gap="100" wrap>
                              {(safetyProduct?.tags || safetyShirtProduct?.tags || constructionProduct?.tags || []).map((tag, index) => (
                  ...
                  <Card>
                    <Box padding="400">
                      <BlockStack gap="400">
                        ...
                        <Text variant="headingMd" tone="success">
                          ${safetyProduct?.price_numeric?.toFixed(2) || safetyShirtProduct?.price_numeric?.toFixed(2) || constructionProduct?.price_numeric?.toFixed(2) || displayProduct.price?.toFixed?.(2) || displayProduct.price}
                        </Text>
